...
var kamiInfo = null;
// kami-widget默认安装的目录
var kamiWidgets = 'src/yo/lib';
// kami-demo默认安装的目录
var kamiDemo = 'src/yo/lib';
// kami-adapter默认安装的目录
...
exports.set_options = function( optimist ){
	optimist.describe('init', 'yo组件初始化。');

    optimist.alias('i', 'install');
    optimist.describe('i', '根据配置'+yoConfigFile+'加载组件');

    optimist.alias('l', 'list');
    optimist.describe('l', '查看yo所有的组件列表。');

    optimist.describe('local', '查看本地安装的yo组件列表。');

    optimist.alias('a', 'add');
    optimist.describe('a', '添加yo组件');

    optimist.alias('u', 'update');
    optimist.describe('u', '更新yo组件');

    optimist.alias('d', 'del');
    optimist.describe('d', '删除yo组件');
    ...
    //optimist.describe('r', '源地址，默认: http://ued.qunar.com/yo-source/');

    //optimist.alias('h', 'history');
    //optimist.describe('h', 'yo组件的历史版本记录');
    ...
    optimist.describe('detail', '详细帮助参见https://github.com/guhuina/fekit-extension-yo');
